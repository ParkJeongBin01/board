...
<table class="table table-hover">
    ...
    <tr>
        ...
        <th style="width: 200px; text-align: center">등록일</th>
    </tr>
    </thead>
    <tbody>
    <c:forEach var="board" items="${list}">
        <tr>
            ...
            <td style="width: 200px; text-align:center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis">${board.writer}</td>
